...
class CacheService
{
    ...
    public function warmUp(): array
    {
        ...
        $gameStats = [
            ...
            'active_gangs' => \App\Plugins\Gang\Models\Gang::count(),
            'total_crimes' => \App\Plugins\Crimes\Models\CrimeAttempt::count(),
            'total_combats' => \App\Plugins\Combat\Models\CombatLog::count(),
        ];
