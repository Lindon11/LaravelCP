...
class ForumModule extends Module
{
    ...
    {
        $categories = \App\Models\ForumCategory::withCount(['topics', 'posts'])
            ->orderBy('order')
            ->get();
    ...
    {
        return [
            'topics' => \App\Models\ForumTopic::count(),
            'posts' => \App\Models\ForumPost::count(),
            'categories' => \App\Models\ForumCategory::count(),
        ];
    }
}
