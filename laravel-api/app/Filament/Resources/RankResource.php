        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('required_level')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('attack_bonus')
                    ->required()
                    ->numeric()
                    ->default(0),
                Forms\Components\TextInput::make('defense_bonus')
                    ->required()
                    ->numeric()
                    ->default(0),
            ]);
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('required_level')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('attack_bonus')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('defense_bonus')
                    ->numeric()
                    ->sortable(),
