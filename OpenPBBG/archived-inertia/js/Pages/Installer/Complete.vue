<template>
    <Layout current-step="complete" :hide-progress="true">
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">
                                Visit your game at: <a :href="appUrl" class="text-purple-400 hover:underline">{{ appUrl }}</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">
                                Manage your game at: <a :href="`${appUrl}/admin`" class="text-purple-400 hover:underline">{{ appUrl }}/admin</a>
                            </p>
                        </div>
                    </div>
