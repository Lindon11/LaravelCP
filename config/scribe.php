...
return [
    ...
    'description' => 'LaravelCP Game API - A comprehensive PBBG (Persistent Browser-Based Game) backend providing authentication, game mechanics, tickets, and admin functionality.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses <b>Laravel Sanctum</b> for authentication. After logging in via <code>/api/login</code>, you will receive an access token. Include this token in the <code>Authorization</code> header as <code>Bearer YOUR_ACCESS_TOKEN</code> for all authenticated requests.',
    ],
